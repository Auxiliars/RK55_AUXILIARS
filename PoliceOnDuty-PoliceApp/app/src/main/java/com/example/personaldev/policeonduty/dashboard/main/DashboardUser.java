...
//                Intent intent12 = new Intent (DashboardUser.this, Statistics_activity.class);
//                startActivity(intent12);
//                break;

            case R.id.nav_SOS:
                Intent intent13 = new Intent (DashboardUser.this, SOS_Emergency.class);
                startActivity(intent13);
                break;

            case R.id.nav_dbd1_heatMap:
                Intent intent1 = new Intent (DashboardUser.this, Heat_Map.class);
                startActivity(intent1);
                break;

//            case R.id.nav_dbd2_addCriminalRepo:
//                Intent intent2 = new Intent (DashboardUser.this, Add_Criminal_Report.class);
//                startActivity(intent2);
//                break;
//
//            case R.id.nav_dbd3_viewCriminalRepo:
//                Intent intent3 = new Intent (DashboardUser.this, Criminal_detailed_view.class);
//                startActivity(intent3);
//                break;

            case R.id.nav_dbd4_SOS_repo:
                Intent intent4 = new Intent (DashboardUser.this, SOS_Report.class);
                startActivity(intent4);
                break;
            case R.id.nav_app_my_profile:
                Intent intent_pp = new Intent (DashboardUser.this, police_profile.class);
